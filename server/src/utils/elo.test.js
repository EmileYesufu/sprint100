...
describe('ELO Rating System', () => {
    describe('calculateElo - new API', () => {
        test('winner gains, loser loses, total change ≈ 0', () => {
            const { winnerNew, loserNew } = (0, elo_1.calculateElo)(1200, 1200, true);
        ...
        test('extreme rating differences (1000 vs 2000)', () => {
            ...
            const upsetWin = (0, elo_1.calculateElo)(1000, 2000, true);
            ...
            const expectedWin = (0, elo_1.calculateElo)(2000, 1000, true);
        ...
        test('rating changes are symmetric (zero-sum)', () => {
            const { p1New, p2New } = (0, elo_1.calculateElo)(1300, 1250, true);
        ...
        test('returns integer values (rounded)', () => {
            const { p1New, p2New } = (0, elo_1.calculateElo)(1234, 1567, true);
    ...
    describe('ELO formula verification', () => {
        test('expected score calculation is correct', () => {
            ...
            const { p1New } = (0, elo_1.calculateElo)(1200, 1200, true);
        ...
        test('400-point difference means ~90% expected win rate', () => {
            ...
            const { p1New: highWin } = (0, elo_1.calculateElo)(higherRating, lowerRating, true);
            expect(highWin - higherRating).toBeLessThan(6);
            // Loss delta should be large (high surprise)
            const { p1New: highLose } = (0, elo_1.calculateElo)(higherRating, lowerRating, false);
            expect(higherRating - highLose).toBeGreaterThan(26);
        });
    });
    describe('Real-world scenarios', () => {
        test('new player (1200) beats experienced (1600)', () => {
            const { p1New, p2New } = (0, elo_1.calculateElo)(1200, 1600, true);
        ...
        test('closely matched players (1450 vs 1470)', () => {
            const { p1New: p1WinNew } = (0, elo_1.calculateElo)(1450, 1470, true);
            const p1WinGain = p1WinNew - 1450;
            expect(p1WinGain).toBeGreaterThanOrEqual(15);
            expect(p1WinGain).toBeLessThanOrEqual(18);
            const { p1New: p2WinNew } = (0, elo_1.calculateElo)(1470, 1450, true);
        ...
        test('series of matches affects ratings progressively', () => {
            ...
            for (let i = 0; i < 3; i++) {
                const result = (0, elo_1.calculateElo)(rating1, rating2, true);
            ...
            const nextMatch = (0, elo_1.calculateElo)(rating1, rating2, true);
...
//# sourceMappingURL=elo.test.js.map